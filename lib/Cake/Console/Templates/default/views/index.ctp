...
<div class="<?php echo $pluralVar; ?> index">
	...
	echo "\t<tr>\n";
		...
		echo "\t\t\t<?php echo \$this->Form->postLink(__('Delete'), array('action' => 'delete', \${$singularVar}['{$modelClass}']['{$primaryKey}']), array('confirm' => __('Você tem certeza que deseja excluir # %s?', \${$singularVar}['{$modelClass}']['{$primaryKey}']))); ?>\n";
		echo "\t\t</td>\n";
	echo "\t</tr>\n";
