<div class="viewTaskComments index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $viewTaskComment['ViewTaskComment']['id']), array('confirm' => __('Você tem certeza que deseja excluir # %s?', $viewTaskComment['ViewTaskComment']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
