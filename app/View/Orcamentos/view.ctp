...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Orcamento'), array('action' => 'delete', $orcamento['Orcamento']['id']), array(), __('Are you sure you want to delete # %s?', $orcamento['Orcamento']['id'])); ?> </li>
